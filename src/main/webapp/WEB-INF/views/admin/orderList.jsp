			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>${o.orderDate}</td>
						<%
							com.lizheyang.model.Order o=(com.lizheyang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.lizheyang.dao.UserDao userDao=new com.lizheyang.dao.UserDao();
						...
						<%
							...
							String paymentType=com.lizheyang.model.Payment.findByPaymentId(con,n);
						%>
